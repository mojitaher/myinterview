    ...
    <div className="max-w-3xl mx-auto p-8 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg font-sans text-gray-800 dark:text-gray-100">
      ...
      <section className="mb-10 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <p className="leading-relaxed">
          ...
          hands-on experience in React, Next.js, and TypeScript, I enjoy turning
          designs into pixel-perfect, user-friendly interfaces. I am eager to
          learn and grow professionally, and I thrive in collaborative
          environments where innovation and quality matter.
        </p>
      </section>
      ...
      <section className="mb-10 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <div className="mb-6">
          ...
          <p className="mb-2">
            ...
            using React and Tailwind CSS. Integrated with external movie APIs to
            fetch and display up-to-date movie information. Ensured cross-device
            usability with responsive design principles.
          </p>
          <a
        ...
        <div className="mb-6">
          ...
          <p className="mb-2">
            Created a clean and semantic website using pure HTML and CSS without
            JavaScript. Focused on layout precision and cross-browser
            compatibility.
          </p>
          <a
        ...
        <div>
          ...
          <p className="mb-2">
            ...
            showcasing my skills. Implemented with responsive design principles
            to ensure usability on various devices. Focused on clean layout and
