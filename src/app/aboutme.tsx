...
export default function Aboutme() {
  ...
  return (
    <div id="about">
      ...
      <div className="flex justify-between p-6 gap-5 items-center dark:bg-gradient-to-b dark:from-[#001f1f] dark:via-[#000000] dark:to-[#001f1f] rounded-3xl border border-[#3e3c3c] bg-gradient-to-r from-[#e0f7fa] via-[#f5fdff] to-[#ffffff]">
